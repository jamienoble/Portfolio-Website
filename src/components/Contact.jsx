        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 max-w-6xl mx-auto">
          ...
          <div className="bg-white rounded-lg shadow-xl p-8">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <button
                type="submit"
                className="w-full bg-accent text-white font-bold py-4 px-6 rounded-lg hover:bg-primary transition-colors duration-300 shadow-lg hover:shadow-xl transform hover:-translate-y-1"
              >
                Send Message
              </button>
            </form>
          ...
          <div className="space-y-8">
            <div className="bg-white rounded-lg shadow-xl p-8">
              ...
              <div className="space-y-6">
                <div className="flex items-start space-x-4">
                  <div className="w-12 h-12 bg-bglight rounded-lg flex items-center justify-center flex-shrink-0">
                  ...
                  <div>
                    ...
                    <p className="text-neutral">info@creativecollective.com</p>
                    <p className="text-neutral">projects@creativecollective.com</p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-neutral">+1 (555) 987-6543</p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-neutral">123 Creative Street</p>
                    <p className="text-neutral">Design District</p>
                    <p className="text-neutral">New York, NY 10001</p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-neutral">Saturday: 10:00 AM - 4:00 PM</p>
            ...
            <div className="bg-white rounded-lg shadow-xl p-8">
              ...
              <div className="flex space-x-4">
                <a href="#" className="w-12 h-12 bg-accent rounded-lg flex items-center justify-center hover:bg-primary transition-colors">
