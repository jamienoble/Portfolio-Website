...
function About() {
  ...
  return (
    <section id="about" className="py-20 bg-bglight">
      <div className="container mx-auto px-6">
          ...
          <div className="max-w-4xl mx-auto">
            <div className="bg-white rounded-lg shadow-lg p-8 md:p-12">
              ...
              <p className="text-lg text-gray-700 mb-6 leading-relaxed">
                ...
                of independent professionals while providing our clients with the reliability 
        ...
        {/* Services Section */}
        <div className="mb-20">
          <h3 className="text-3xl md:text-4xl font-bold text-primary mb-12 text-center">
            Our Services
          </h3>
            ...
            {teamMembers.map((member, index) => (
              ...
              >
                ...
                <div className="p-6">
                  ...
                  <p className="text-sm text-neutral mb-3 font-medium">{member.specialty}</p>
        ...
        <div className="mt-20">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            ...
            <div className="text-center">
              ...
              <h4 className="text-xl font-bold text-primary mb-2">Collaboration</h4>
              <p className="text-neutral">
